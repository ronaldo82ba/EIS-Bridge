...
class BirSchemaValidator
{
    ...
    private function laravelRules(): array
    {
        return [
            ...
            'merchant.trade_name' => ['nullable', 'string'],
            'merchant.tin' => ['nullable', 'string'],
            'merchant.vat_registered' => ['nullable', 'boolean'],
            'merchant.rdo_code' => ['nullable', 'string'],
            'merchant.address' => ['nullable', 'string'],
            'merchant.bir_ack_number' => ['nullable', 'string'],
            'merchant.bir_ack_date' => ['nullable', 'date'],
